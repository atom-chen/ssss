...
function DeployTopBar:ctor()
	...
	self.titleLabel:setTextColor(cc.num2c4b(0xfee8b7))
	self.titleLabel:enableOutline(cc.num2c4b(0x401700), 2)
	...
	reslbl:setTextColor(cc.num2c4b(0x853f21))
	...
	self.silverNum:setTextColor(cc.num2c4b(0x49ffa6))
	self.silverNum:enableOutline(cc.num2c4b(0x5d2201))
	...
	self.goldNum:setTextColor(cc.num2c4b(0x49ffa6))
	self.goldNum:enableOutline(cc.num2c4b(0x5d2201))
